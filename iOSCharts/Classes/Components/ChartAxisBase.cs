...
namespace iOSCharts
{
    ...
    {
        public UIFont labelFont = UIFont.SystemFontOfSize(10.0f);
        ...
        {
            return "getLongestLabel() cannot be called on ChartAxisBase";
            //fatalError("getLongestLabel() cannot be called on ChartAxisBase");
        }

        public bool isDrawGridLinesEnabled { get { return drawGridLinesEnabled; } }

        public bool isDrawAxisLineEnabled { get { return drawAxisLineEnabled; } }

        public bool isDrawLabelsEnabled { get { return drawLabelsEnabled; } }

        /// Are the LimitLines drawn behind the data or in front of the data?
        /// 
        /// **default**: false
        public bool isDrawLimitLinesBehindDataEnabled { get { return drawLimitLinesBehindDataEnabled; } }
